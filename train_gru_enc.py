...
from metrics import evaluate_gru
...
def checkpoint_model(encoder, decoder, emb_dim, learning_rate, iterations):
    save_model(encoder, "n_encoder_gru_enc", emb_dim, learning_rate, iterations)
    save_model(decoder, "n_decoder_gru_enc", emb_dim*2, learning_rate, iterations)
...
if __name__ == "__main__":
    ...
    for iteration in range(epochs):
        ...
        bleu_score = evaluate_gru(encoder, decoder, validation_dataloader, validation_pc)
    ...
    save_losses(f"models/n_loss_training_gru_enc_1000.txt", loss_per_iter)
    save_losses(f"models/n_bleu_validation_gru_enc_1000.txt", bleu_per_iter)
    save_model(encoder, "n_encoder_gru_enc", word_embedding_dim, learning_rate, epochs)
    save_model(decoder, "n_decoder_gru_enc", word_embedding_dim*2, learning_rate, epochs)
